...
function handler(req,res){
    ...
    var imgFile = './images/' + id + '.jpg';
    serviceManager.log('Reading image from file: ' + imgFile, requestToken);
    ...
    serviceManager.log('Image size: ' + data.length, requestToken);
    serviceManager.log("Image supplied id: " + id, requestToken);
}

serviceManager.endpointGet('/images/:id', "Processing image request", handler);
